...
claude_mani_dfm_trimmed <- dfm_trim(claude_mani_dfm, min_termfreq = 10)
...
# Step 11: Extract Loadings (word contributions to PCs)
pca_loadings <- as.data.frame(pca_result$rotation)

# Step 12: Plot the Loadings for PC1 and PC2
